      ...
      >
          ...
          {HOUR_OPTIONS.map((h) => (
            <TouchableOpacity
              ...
              style={[
                ...
                hours === h && { borderColor: sleepColor },
              ]}
              onPress={() => setHours(h)}
            >
              <Text
        ...
        <View style={styles.goalBar}>
          ...
          <View style={styles.goalBarLabels}>
            ...
            <Text style={[styles.goalBarLabel, { color: "#9D85F5" }]}>
              Goal: 8h
            </Text>
          ...
          {QUALITY_OPTIONS.map((q) => (
            <TouchableOpacity
              ...
              style={[
                ...
                quality === q.value && { borderColor: q.color },
              ]}
              ...
              <View style={styles.timeChips}>
                {BEDTIMES.map((t) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.timeChip,
                      bedtime === t && styles.timeChipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.timeChipTxt,
                        bedtime === t && styles.timeChipTxtActive,
                      ]}
                    >
                      {t}
                    </Text>
              ...
              <View style={styles.timeChips}>
                {WAKETIMES.map((t) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.timeChip,
                      wakeTime === t && styles.timeChipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.timeChipTxt,
                        wakeTime === t && styles.timeChipTxtActive,
                      ]}
                    >
                      {t}
                    </Text>
        ...
        {quality && (
          <View
            style={[
              styles.insightCard,
              { borderColor: qualityObj.color + "50" },
            ]}
          >
            <Text style={styles.insightEmoji}>{qualityObj.emoji}</Text>
            <Text style={[styles.insightText, { color: qualityObj.color }]}>
              {SLEEP_INSIGHTS[quality]}
            </Text>
          </View>
        )}
