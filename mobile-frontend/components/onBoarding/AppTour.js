      ...
      <Animated.View style={[StyleSheet.absoluteFill, { opacity: overlayOp }]}>
        ...
        {computed.hasSpot ? (
          <>
            {/* top */}
            <Animated.View
              style={[s.mask, { top: 0, left: 0, right: 0, height: sT }]}
            />
            {/* bottom */}
            <Animated.View
              style={[
            ...
            {/* left */}
            <Animated.View
              style={[s.mask, { top: sT, left: 0, width: sL, height: sH }]}
            />
            {/* right */}
            <Animated.View
              style={[
            ...
            <Animated.View
              style={[
                s.cTL,
                {
                  left: Animated.subtract(sL, 1),
                  top: Animated.subtract(sT, 1),
                },
              ]}
            />
            <Animated.View
