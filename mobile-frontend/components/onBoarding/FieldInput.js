...
export default function FieldInput({ label, value, onChange, placeholder, unit, T, optional, isDate }) {
  return (
...
const s = StyleSheet.create({
  ...
  wrap:  { flexDirection:'row', alignItems:'center', borderRadius:14, borderWidth:1.5, paddingHorizontal:14, paddingVertical:13, gap:8 },
