...
export default function SelectCard({ emoji, title, sub, selected, onPress, T }) {
  return (
    <TouchableOpacity
      style={[s.card, { backgroundColor: T.card, borderColor: selected ? T.purple : T.border },
    ...
    >
      ...
      <View style={[s.check, { borderColor: selected ? T.purple : T.border },
...
const s = StyleSheet.create({
  card:  { flexDirection:'row', alignItems:'center', borderRadius:16, padding:16, gap:14, borderWidth:1.5 },
