 ...
 */
export default function MacroBar({ label, eaten, goal, color, showGoal = true }) {
  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.track}>
        <Animated.View style={[styles.fill, { width, backgroundColor: over ? '#FF6B6B' : color }]} />
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  track:     { height: 6, backgroundColor: '#251E42', borderRadius: 3, overflow: 'hidden' },
